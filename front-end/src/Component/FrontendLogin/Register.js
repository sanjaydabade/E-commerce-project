...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/front-register', { // Adjust the URL as needed
        method: 'POST',
        headers: {
      ...
      setMessage({ text: 'Error occurred during registration.', type: 'error' });
    ...
    <>
      <div className="form-container">
        ...
        <p className="sign-up-label">
          Already have an account?<Link to="/front-login" className="sign-up-link">Log in</Link>
        </p>
